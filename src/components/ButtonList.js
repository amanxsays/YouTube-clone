...
const ButtonList = () => {
  ...
  const tagsList=['Top In India','Panchayat S04','Latest Songs','Maadhur Virli','Purav Jha','NIT SILCHAR','LIVE','GTA6','STtand Up','Plain Crash','News','Football','Fun','Ind Vs Pak'];
  return (
