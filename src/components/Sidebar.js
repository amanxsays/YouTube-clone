...
const Sidebar = () => {
  ...
  return (
    <div >
    <div className='bg-[#0f0f0f] px-4 z-10 absolute h-screen'>
        <ul>
    ...
    <div class="absolute z-10 top-0 left-[35vh] w-[174vh] h-[115.5%] bg-[#00000071] cursor-pointer" onClick={()=>handleClick()}></div>
    </div>
  )
}
